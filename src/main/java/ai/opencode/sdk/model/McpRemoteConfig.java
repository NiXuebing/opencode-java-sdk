...
public final class McpRemoteConfig implements McpAddBodyConfig {
  @JsonProperty("type")
  ...
  public boolean equals(Object other) {
    if (!(other instanceof McpRemoteConfig)) return false;
    McpRemoteConfig that = (McpRemoteConfig) other;
