...
public final class ModelCapabilitiesInput {
  @JsonProperty("text")
  ...
  public boolean equals(Object other) {
    if (!(other instanceof ModelCapabilitiesInput)) return false;
    ModelCapabilitiesInput that = (ModelCapabilitiesInput) other;
