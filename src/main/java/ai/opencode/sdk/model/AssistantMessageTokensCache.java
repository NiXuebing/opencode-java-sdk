...
public final class AssistantMessageTokensCache {
  @JsonProperty("read")
  ...
  public boolean equals(Object other) {
    if (!(other instanceof AssistantMessageTokensCache)) return false;
    AssistantMessageTokensCache that = (AssistantMessageTokensCache) other;
