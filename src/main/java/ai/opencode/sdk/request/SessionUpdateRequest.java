...
public final class SessionUpdateRequest {
  ...
  @JsonProperty("body")
  private final SessionUpdateBody body;
   ...
   * @return 请求体内容。
   */
  public SessionUpdateBody body() {
    return body;
  }

  @Override
  public boolean equals(Object other) {
    if (!(other instanceof SessionUpdateRequest)) return false;
    SessionUpdateRequest that = (SessionUpdateRequest) other;
